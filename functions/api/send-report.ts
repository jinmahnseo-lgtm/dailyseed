...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  try {
    ...
    html += `<p style="margin:8px 0 0;color:#666;">매일의 씨앗 — 이제 함께 대화해요!</p>`;
    html += `</div>`;
    ...
    html += `<tr><td style="padding:8px 0;color:#888;">회차</td><td style="padding:8px 0;">${dayLabel}</td></tr>`;
    ...
    const subject = `🌱 DailySeed — ${studentName}의 ${dayLabel} 미션 통지 - 이제 함께 대화해요!`;
