...
export default function NewsContent({ item, dayNumber }: { item: NewsItem | null; dayNumber: number }) {
  ...
  return (
    ...
    >
      <DayNavigator title="오늘의 뉴스" emoji="📰" topicKey="news" dayNumber={dayNumber} />
