...
export default function ClassicContent({ item, dayNumber }: { item: ClassicItem | null; dayNumber: number }) {
  ...
  return (
    ...
    >
      <DayNavigator title="오늘의 고전" emoji="📖" topicKey="classic" dayNumber={dayNumber} />
