...
interface WorldItem {
  ...
  food: string | { name: string; description: string };
  fun_fact: string;
  quiz: {
    question: string;
    options: string[];
...
export default function WorldContent({ item, dayNumber }: { item: WorldItem | null; dayNumber: number }) {
  ...
  return (
    ...
    >
      <DayNavigator title="오늘의 세계" emoji="🌍" topicKey="world" dayNumber={dayNumber} />
